...
import { FamilyAttributesModule } from 'src/family_attributes/family_attributes.module';

@Module({
  controllers: [OlfactiveFamiliesController],
  providers: [
    OlfactiveFamiliesService,
    OlfactiveFamiliesMapper,
    OlfactiveFamiliesRepository,
  ],
