...
import { AssociatedNoteInsert, AssociatedNoteSelect } from './_utils/types/associated-notes.types';
...
export class AssociatedNotesRepository {
  ...
  async createMany(relations: AssociatedNoteInsert[]): Promise<AssociatedNoteSelect[]>{
